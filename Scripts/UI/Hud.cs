...
public partial class Hud : Control
{
  ...
  {
    if (_healthBar == null || _healthLabel == null) return;
  ...
  {
    if (_goldLabel == null || _essenceLabel == null || _partsLabel == null || _fragmentsLabel == null) return;
